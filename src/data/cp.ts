...
export const cpProblems: CpProblem[] = [
  ...
  },
  {
    ...
    setId: 'programming-in-th',
    label: '2006',
    title: 'สี่เหลี่ยมพิฆาต: จัตุรัสที่หมุนกลับหัวแล้วยังเป็นตัวเดิม',
    desc: 'หาจัตุรัสย่อยที่ใหญ่ที่สุดซึ่งหมุน 180 องศาแล้วเหมือนเดิม ไล่ตรง ๆ คือแปดหมื่นสองพันล้านครั้งใน 1 วินาที เฉลยด้วยการสังเกตว่าการหมุนไม่เคยพาช่องข้ามวง จัตุรัสจึงปอกได้ทีละชั้นเหมือนหัวหอม',
  ...
  },
  {
    ...
    setId: 'programming-in-th',
    label: '2000',
    title: 'โมบาย: กิ่งทั้งกิ่งยุบเหลือป้ายสามแบบ',
    desc: 'สลับปลายแกนให้น้อยที่สุดจนโมบายแสนแกนกลายเป็นทรงที่ไอค์ยอมรับ หน้าตาที่เป็นไปได้คือสองยกกำลังแสน แต่การสลับเปลี่ยนชั้นของของเล่นไม่ได้เลย พอรู้ข้อนี้ทุกแกนก็เหลือทางเดียวที่ทำได้',
  ...
  },
  {
    ...
    setId: 'programming-in-th',
    label: '2032',
    title: 'ยิงธนู: แทรกแถวเข้าไปในวงที่หมุนพันล้านรอบ',
    desc: 'เลือกจุดแทรกตัวเองในแถว 2N คน แล้วแข่งไปพันล้านรอบเพื่อจบให้ใกล้เป้าแรกที่สุด เฉลยด้วยการทิ้งหมายเลขทักษะของทุกคนเหลือแค่ 0 กับ 1 แล้วใช้ข้อรับประกัน R ≥ 2N ที่โจทย์แถมมาให้ตัดพันล้านรอบเหลือไม่กี่เท่าของ N',
