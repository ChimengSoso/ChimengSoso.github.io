...
export const divineLoreEntries: DivineLoreEntry[] = [
  {
    ...
    desc: 'Bitcoin v0.1 ที่ปล่อยเมื่อ 9 มกราคม 2009 ยังอ่านได้ครบทุกบรรทัด หน้านี้พาไล่ดูว่ากติกาแต่ละข้อหน้าตาเป็นยังไงในโค้ดจริง ตั้งแต่หัวบล็อกหกช่องไปจนถึงห้องแชต IRC',
    dateISO: '2026-09-06',
    readingMinutes: 12,
  },
  {
    ...
    desc: 'เห็นคำว่าบิตคอยน์มาสิบกว่าปี แต่พอมีคนถามว่ามันทำงานยังไง ก็ยังตอบไม่ได้สักที บทนี้เริ่มจากศูนย์ ไม่ต้องรู้อะไรมาก่อน มีของให้กดเล่นสิบชิ้น และภาพประกอบกว่าห้าสิบภาพระหว่างทาง',
    dateISO: '2026-08-30',
