...
export const divineLoreEntries: DivineLoreEntry[] = [
  {
    ...
    desc: 'เห็นคำว่าบิตคอยน์มาสิบกว่าปี แต่พอมีคนถามว่ามันทำงานยังไง ก็ยังตอบไม่ได้สักที บทนี้เริ่มจากศูนย์ ไม่ต้องรู้อะไรมาก่อน มีของให้กดเล่นหกชิ้นระหว่างทาง',
    dateISO: '2026-08-30',
    readingMinutes: 43,
  },
  {
