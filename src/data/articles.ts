...
export const articles: Article[] = [
  ...
  },
  {
    href: 'watch/',
    tag: 'Claude Code',
    title: 'ทำให้ Claude ดูวิดีโอเป็น ด้วย /watch (แถมให้มันตัดต่อด้วย)',
    desc: 'วางลิงก์ยูทูบให้ Claude มันได้แค่เดาจากชื่อคลิป ไม่เคยเห็นภาพสักเฟรม — ปลั๊กอิน /watch ทำให้มันดูคลิปจริง เห็นภาพ ได้ยินเสียง แถมสอนให้มันลงมือตัดต่อด้วย FFmpeg ได้ในตัว',
    dateISO: '2026-07-22',
    readingMinutes: 11,
    soon: false,
  },
  {
    href: 'video-editing/',
    tag: 'Claude Code',
    title: 'ให้ Claude ตัดต่อวิดีโอแทนเรา: FFmpeg, CapCut หรือคุม Premiere สด ๆ',
    desc: 'เห็นคนโชว์ในเน็ตว่าสั่ง AI ตัดคลิปได้ทั้งตัว อยากทำบ้างแต่ไม่รู้เริ่มตรงไหน — พาลอง 3 เส้นทางจริงพร้อมวิธีติดตั้ง เทียบจุดแข็ง-จุดเสี่ยงของแต่ละทาง และอนาคตที่ Adobe เพิ่งเปิดตัว agent ของตัวเอง',
    dateISO: '2026-07-23',
    readingMinutes: 14,
    soon: false,
  },
  {
    ...
    tag: 'Claude Code',
    title: 'ตั้งบริษัทซอฟต์แวร์ที่ไม่มีพนักงานเป็นคนสักคน',
    desc: 'เปิดบริษัทซอฟต์แวร์ของตัวเอง แต่ไม่ต้องจ้างพนักงานสักคน — ทีมที่มี Lead แบ่งงาน มีลูปแก้งาน และเด้งกลับมาถามเราเมื่อโจทย์ไม่ชัด คือของจริงที่ทำได้วันนี้แค่ไหน',
    dateISO: '2026-07-16',
    readingMinutes: 13,
    // ปิดชั่วคราว: ยังไม่อยากเผยแพร่ กลับมาเปิดได้โดยเปลี่ยนเป็น false
    soon: true,
  },
  {
    href: 'ai-taste/',
  ...
  },
  {
    href: 'new-languages/',
    tag: 'มุมมอง',
    title: 'ถ้า AI เขียนได้ทุกภาษา เราจะไม่ได้เห็นภาษาใหม่อีกแล้วใช่ไหม',
    desc: 'พอ AI เขียนได้ทุกภาษาโปรแกรม อดคิดไม่ได้ว่าภาษาใหม่คงหมดยุค — แต่ความจริงกลับหัว ภาษาใหม่ไม่เคยเกิดเพราะคนเขียนของเก่าไม่ได้ และภัยตัวจริงเป็นคนละอันกับที่เรากลัว พร้อมชวนใจหายไปอีก 100 ปีข้างหน้า',
    dateISO: '2026-07-12',
    readingMinutes: 18,
    soon: false,
  },
