...
export const UI = {
  ...
  neverEnds: { th: 'ดอกเบี้ยล้วน ยอดไม่ลดเอง ต้องเอาเงินสดไปปิดเท่านั้น', en: 'Interest only: the balance never falls by itself and must be repaid as a lump.' },
  payoffSaves: { th: 'ปิดตอนนี้ประหยัดดอกได้', en: 'Clearing it now saves' },
  mortgageOn: { th: 'ค่าผ่อนต่อเดือน', en: 'Mortgage payment' },
  rentGross: { th: 'ค่าเช่าก่อนหักผ่อน', en: 'Rent before the mortgage' },
  charityBody: {
